  ...
  <div>
    ...
    <div style="background-color: blueviolet; padding-top: 20px; background-image: url('/images/user_back_image.png');">
      ...
      <div style="text-align: center;">
        <img :src="user.photo" style="border-radius: 50%; height: 100px; width: 100px; border: 1px solid white;">
      </div>
      <!-- 昵称 -->
    ...
    <div>
      <el-row :gutter="24" style="width: 100; text-align: center; margin: 0 auto;">
        <el-col :span="6">
          <div @click="doClick('/me/message')" style="width: 60px; cursor: pointer;">
            <el-image src="/icons/myMessage.png" style="width: 50px; height: 50px;"></el-image>
            <div>我的私信</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div @click="doClick('/me/topic')" style="width: 60px; cursor: pointer;">
            <el-image src="/icons/myTopic.png" style="width: 50px; height: 50px;"></el-image>
            <div>我的发帖</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div @click="doClick('/me/focus')" style="width: 60px; cursor: pointer;">
            <el-image src="/icons/myFocus.png" style="width: 50px; height: 50px;"></el-image>
            <div>我的关注</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div @click="doClick('/me/self')" style="width: 60px; cursor: pointer;">
  ...
  export default {
    ...
    methods: {
      refresh() {
        ...
        // 获取个人信息
        this.$axios.get(this.$urls.user.user, {
            params: {
              uid: this.uid
            }
          })
